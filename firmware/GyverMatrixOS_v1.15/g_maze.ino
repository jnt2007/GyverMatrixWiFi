...
#define MAZE_WIDTH 19     // ширина лабиринта
#define MAZE_HEIGHT 11    // высота лабиринта
#define SHIFT 1           // (1 да / 0 нет) смещение лабиринта (чтобы не видеть нижнюю и левую стену)

#define MAX_STRAIGHT 3    // максимальная длина прямых отрезков пути по краям
#define HOLES 1           // количество дырок в стенах
#define MIN_PATH 70       // минимальная длина пути к выходу
